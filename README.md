...
```
To pass an input atomspace, replace `/full/path/to/atomspace.metta` above with the absolute path to your `.metta` file (for example: `/home/user/my_file.metta:/PeTTa/mount/atomspace.metta`).
